...
namespace SEO_WebApi_Test
{
    public class RegexHelperTest
    {
        ...
        /// </summary>
        [Test]
        public void GetAllCiteTags_EmptyText_ReturnEmptyList()
        {
            // Arrange
            var text = string.Empty;
            var expected = new List<string> { };
            ...
            // Act
            var actual = _regexHelper.GetAllCiteTags(text);
        ...
        /// </summary>
        [Test]
        public void GetAllCiteTags_NullText_ReturnEmptyList()
        {
            // Arrange
            string text = null;
            var expected = new List<string> { };
        ...
        /// <summary>
        /// Test with text having Cite tag returning list with cite
        /// </summary>
        [Test]
        public void GetAllCiteTags_Tag_ReturnListWithTag()
        {
            // Arrange
            string text = @"First cite <cite class=""iUh30"">https://www.smokeball.com.au</cite>";
            var expected = new List<string>
            {
                @"<cite class=""iUh30"">https://www.smokeball.com.au</cite>",
            };
        ...
        /// <summary>
        /// Test with text parameter with no cite tags returning empty list
        /// </summary>
        [Test]
        public void GetAllCiteTags_TextWithNoUrls_ReturnEmptyList()
        {
            // Arrange
            string text = "First Url second url ";
            var expected = new List<string>();
